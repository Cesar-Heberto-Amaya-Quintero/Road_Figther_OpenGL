...
class Pajaro(Modelo):
    ...
    def actualizar(self, tiempo_delta):
        ...
        #CREO QUE PODEMOS HACERLO COMO LOS ENEMIGOSS, DE QUE SOLO HACERLO UNA VEZ AKI Y MANDARLO A LLAMAR 2 VECES
        #VAMOS A INTENTAR ESO PRIMERO Y SI YA NO JALA POS LO HACEMOS ASÍ COMO HICE LAS LINESA QUE EN TEORIA ESTA MAL XD
        #okis, wenop
        #la vd no le entiendo mucho xddd,, yo tampoco, pero pos el intento se hará, ya jalo una vez, wenop eale
